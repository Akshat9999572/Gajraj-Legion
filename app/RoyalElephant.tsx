export function RoyalElephant() {
  return (
    <div className="royal-elephant" aria-label="Animated royal elephant mascot">
      <svg viewBox="0 0 280 190" role="img" aria-labelledby="elephant-title elephant-description">
        ...
        <desc id="elephant-description">A small crowned elephant with a gently moving head and trunk.</desc>
        <defs>
          <linearGradient id="elephantBody" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#dff6ff"/><stop offset=".48" stopColor="#8dd7f4"/><stop offset="1" stopColor="#3979df"/></linearGradient>
          ...
          <filter id="elephantShadow" x="-30%" y="-30%" width="160%" height="170%"><feDropShadow dx="0" dy="8" stdDeviation="7" floodColor="#111318" floodOpacity=".24"/></filter>
        </defs>
        <ellipse className="elephant-ground" cx="140" cy="169" rx="89" ry="12" fill="#111318" opacity=".16"/>
        <g className="elephant-body" filter="url(#elephantShadow)">
          ...
          <path d="M103 108h74" stroke="#1f57d3" strokeWidth="4" opacity=".45"/>
          ...
          <path className="elephant-saddle" d="M92 52h78l18 50H76l16-50Z" fill="#ff4a36" stroke="#111318" strokeWidth="4" strokeLinejoin="round"/>
          <path d="M95 62h72M86 88h96" stroke="#ffe59b" strokeWidth="5"/>
          <circle cx="109" cy="76" r="5" fill="#ffe59b"/><circle cx="137" cy="76" r="5" fill="#ffe59b"/><circle cx="165" cy="76" r="5" fill="#ffe59b"/>
        </g>
        <g className="elephant-head">
          ...
          <path d="M101 67C74 53 61 72 68 94c5 17 18 27 37 23M181 67c27-14 40 5 33 27-5 17-18 27-37 23" fill="#73bfe5" stroke="#111318" strokeWidth="4"/>
